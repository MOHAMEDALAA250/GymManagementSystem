        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_Street = table.Column<string>(type: "varchar(30)", nullable: true),
                    Address_City = table.Column<string>(type: "varchar(30)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Members", x => x.Id);
                    table.CheckConstraint("EmailValidFormatConstriant", "[Email] like '_%@_%._%'");
                    table.CheckConstraint("PhoneValidFormatEgpConstraint", "[Phone] like '01[0125]%' and [Phone] not like '%[^0-9]%' ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailValidFormatConstriant1", "[Email] like '_%@_%._%'");
                    table.CheckConstraint("PhoneValidFormatEgpConstraint1", "[Phone] like '01[0125]%' and [Phone] not like '%[^0-9]%' ");
                });
